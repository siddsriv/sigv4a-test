...
// src/SignatureV4a.ts
var import_signature_v43 = require("@smithy/signature-v4");
var import_signature_v44 = require("@smithy/signature-v4");
var import_signature_v45 = require("@smithy/signature-v4");
var import_signature_v46 = require("@smithy/signature-v4");
var import_signature_v47 = require("@smithy/signature-v4");
var import_signature_v48 = require("@smithy/signature-v4");
var import_util_hex_encoding = require("@smithy/util-hex-encoding");
var import_util_utf82 = require("@smithy/util-utf8");

// src/constants.ts
var import_signature_v4 = require("@smithy/signature-v4");
var REGION_HEADER = import_signature_v4.REGION_SET_PARAM.toLowerCase();
var ONE_AS_4_BYTES = [0, 0, 0, 1];
var TWOFIFTYSIX_AS_4_BYTES = [0, 0, 1, 0];
var N_MINUS_TWO = [
  255,
  255,
  255,
...
var import_signature_v42 = require("@smithy/signature-v4");
var import_util_utf8 = require("@smithy/util-utf8");
var createSigV4aScope = /* @__PURE__ */ __name((shortDate, service) => `${shortDate}/${service}/${import_signature_v42.KEY_TYPE_IDENTIFIER}`, "createSigV4aScope");
var getSigV4aSigningKey = /* @__PURE__ */ __name(async (sha256, accessKey, secretKey) => {
  ...
  while (trial < maxTrials) {
    ...
    const hashVal = (0, import_util_utf8.toUint8Array)(outputBufferWriter);
    hash.update(hashVal);
...
var buildFixedInputBuffer = /* @__PURE__ */ __name((bufferInput, accessKey, counter) => {
  let outputBuffer = bufferInput;
  outputBuffer += ONE_AS_4_BYTES.map((value) => String.fromCharCode(value)).join("");
  outputBuffer += import_signature_v42.ALGORITHM_IDENTIFIER_V4A;
  ...
  return outputBuffer;
}, "buildFixedInputBuffer");
var isBiggerThanNMinus2 = /* @__PURE__ */ __name((value) => {
...
var addOneToArray = /* @__PURE__ */ __name((value) => {
...
var require_implementation = __commonJS({
  "../../node_modules/is-arguments/node_modules/function-bind/implementation.js"(exports2, module2) {
    "use strict";
...
var require_function_bind = __commonJS({
  "../../node_modules/is-arguments/node_modules/function-bind/index.js"(exports2, module2) {
    "use strict";
...
var require_get_intrinsic = __commonJS({
  "../../node_modules/is-arguments/node_modules/get-intrinsic/index.js"(exports2, module2) {
    "use strict";
    var undefined2;
...
var require_call_bind = __commonJS({
  "../../node_modules/is-arguments/node_modules/call-bind/index.js"(exports2, module2) {
    "use strict";
    var bind = require_function_bind();
...
var require_callBound = __commonJS({
  "../../node_modules/is-arguments/node_modules/call-bind/callBound.js"(exports2, module2) {
    "use strict";
    var GetIntrinsic = require_get_intrinsic();
...
var require_is_generator_function = __commonJS({
  "../../node_modules/is-generator-function/index.js"(exports2, module2) {
    ...
    module2.exports = /* @__PURE__ */ __name(function isGeneratorFunction(fn) {
...
var require_is_callable = __commonJS({
  "../../node_modules/is-callable/index.js"(exports2, module2) {
    ...
    var all;
    module2.exports = reflectApply ? /* @__PURE__ */ __name(function isCallable(value) {
      if (isDDA(value)) {
        return true;
      }
      if (!value) {
...
var require_available_typed_arrays = __commonJS({
  "../../node_modules/util/node_modules/available-typed-arrays/index.js"(exports2, module2) {
    "use strict";
    var possibleNames = [
      "BigInt64Array",
      "BigUint64Array",
    ...
    module2.exports = /* @__PURE__ */ __name(function availableTypedArrays() {
      var out = [];
...
var require_implementation3 = __commonJS({
  "../../node_modules/util/node_modules/function-bind/implementation.js"(exports2, module2) {
    "use strict";
    var ERROR_MESSAGE = "Function.prototype.bind called on incompatible ";
    var slice = Array.prototype.slice;
    var toStr = Object.prototype.toString;
...
var require_function_bind3 = __commonJS({
  "../../node_modules/util/node_modules/function-bind/index.js"(exports2, module2) {
    "use strict";
...
var require_get_intrinsic2 = __commonJS({
  "../../node_modules/util/node_modules/get-intrinsic/index.js"(exports2, module2) {
    "use strict";
    var undefined2;
    var $SyntaxError = SyntaxError;
    var $Function = Function;
...
var require_call_bind2 = __commonJS({
  "../../node_modules/util/node_modules/call-bind/index.js"(exports2, module2) {
    "use strict";
    var bind = require_function_bind3();
...
var require_callBound2 = __commonJS({
  "../../node_modules/util/node_modules/call-bind/callBound.js"(exports2, module2) {
    "use strict";
    var GetIntrinsic = require_get_intrinsic2();
...
var require_implementation4 = __commonJS({
  "../../node_modules/gopd/node_modules/function-bind/implementation.js"(exports2, module2) {
    "use strict";
    var ERROR_MESSAGE = "Function.prototype.bind called on incompatible ";
    var slice = Array.prototype.slice;
    var toStr = Object.prototype.toString;
...
var require_function_bind4 = __commonJS({
  "../../node_modules/gopd/node_modules/function-bind/index.js"(exports2, module2) {
    "use strict";
...
var require_is_typed_array = __commonJS({
  "../../node_modules/util/node_modules/is-typed-array/index.js"(exports2, module2) {
    "use strict";
    ...
    module2.exports = /* @__PURE__ */ __name(function isTypedArray(value) {
...
var require_which_typed_array = __commonJS({
  "../../node_modules/util/node_modules/which-typed-array/index.js"(exports2, module2) {
    "use strict";
    var forEach = require_for_each();
    var availableTypedArrays = require_available_typed_arrays();
    var callBound = require_callBound2();
    ...
    module2.exports = /* @__PURE__ */ __name(function whichTypedArray(value) {
...
var require_short = __commonJS({
  "../../node_modules/elliptic/lib/elliptic/curve/short.js"(exports2, module2) {
    ...
    ShortCurve.prototype.point = /* @__PURE__ */ __name(function point(x, y, isRed) {
...
var require_mont = __commonJS({
  "../../node_modules/elliptic/lib/elliptic/curve/mont.js"(exports2, module2) {
    ...
    MontCurve.prototype.point = /* @__PURE__ */ __name(function point(x, z) {
...
var require_edwards = __commonJS({
  "../../node_modules/elliptic/lib/elliptic/curve/edwards.js"(exports2, module2) {
    ...
    EdwardsCurve.prototype.point = /* @__PURE__ */ __name(function point(x, y, z, t) {
...
var require_key = __commonJS({
  "../../node_modules/elliptic/lib/elliptic/ec/key.js"(exports2, module2) {
    ...
    KeyPair.prototype.verify = /* @__PURE__ */ __name(function verify(msg, signature) {
...
var require_ec = __commonJS({
  "../../node_modules/elliptic/lib/elliptic/ec/index.js"(exports2, module2) {
    ...
    EC.prototype.verify = /* @__PURE__ */ __name(function verify(msg, signature, key, enc) {
      msg = this._truncateToN(new BN(msg, 16));
...
var require_signature2 = __commonJS({
  "../../node_modules/elliptic/lib/elliptic/eddsa/signature.js"(exports2, module2) {
    ...
    __name(Signature, "Signature");
    cachedProperty(Signature, "S", /* @__PURE__ */ __name(function S() {
    ...
    Signature.prototype.toHex = /* @__PURE__ */ __name(function toHex2() {
...
// src/SignatureV4a.ts
var _SignatureV4a = class _SignatureV4a extends import_signature_v48.SignatureV4Base {
  /**
  ...
  async signRequest(requestToSign, {
    ...
    const request = (0, import_signature_v47.prepareRequest)(requestToSign);
    ...
    request.headers[import_signature_v43.AMZ_DATE_HEADER] = longDate;
    if (credentials.sessionToken) {
      request.headers[import_signature_v43.TOKEN_HEADER] = credentials.sessionToken;
    }
    request.headers[REGION_HEADER] = region;
    const payloadHash = await (0, import_signature_v45.getPayloadHash)(request, this.sha256);
    if (!(0, import_signature_v46.hasHeader)(import_signature_v43.SHA256_HEADER, request.headers) && this.applyChecksum) {
      request.headers[import_signature_v43.SHA256_HEADER] = payloadHash;
    }
    const canonicalHeaders = (0, import_signature_v44.getCanonicalHeaders)(request, unsignableHeaders, signableHeaders);
    const canonicalRequest = this.createCanonicalRequest(request, canonicalHeaders, payloadHash);
    const stringToSign = await this.createStringToSign(longDate, scope, canonicalRequest, import_signature_v43.ALGORITHM_IDENTIFIER_V4A);
    const signature = await this.GetSignature(pKey, stringToSign);
    request.headers[import_signature_v43.AUTH_HEADER] = `${import_signature_v43.ALGORITHM_IDENTIFIER_V4A} Credential=${credentials.accessKeyId}/${scope}, SignedHeaders=${this.getCanonicalHeaderList(canonicalHeaders)}, Signature=${signature}`;
    return request;
  }
  /**
   *
  ...
  async GetSignature(privateKey, stringToSign) {
    ...
    hash.update((0, import_util_utf82.toUint8Array)(stringToSign));
    const hashResult = await hash.digest();
    const signature = key.sign(hashResult);
    return (0, import_util_hex_encoding.toHex)(new Uint8Array(signature.toDER()));
  }
};
__name(_SignatureV4a, "SignatureV4a");
var SignatureV4a = _SignatureV4a;
