...
var REGION_HEADER = REGION_SET_PARAM.toLowerCase();
...
var createSigV4aScope = /* @__PURE__ */ __name((shortDate, service) => `${shortDate}/${service}/${import_signature_v4.KEY_TYPE_IDENTIFIER}`, "createSigV4aScope");
...
var buildFixedInputBuffer = /* @__PURE__ */ __name((bufferInput, accessKey, counter) => {
  ...
  outputBuffer += import_signature_v4.ALGORITHM_IDENTIFIER_V4A;
...
// src/SignatureV4a.ts
var SignatureV4a = class extends import_signature_v47.SignatureV4Base {
  static {
    __name(this, "SignatureV4a");
  }
  /**
  ...
  async signRequest(requestToSign, {
    ...
    const request = (0, import_signature_v46.prepareRequest)(requestToSign);
    ...
    request.headers[import_signature_v42.AMZ_DATE_HEADER] = longDate;
    if (credentials.sessionToken) {
      request.headers[import_signature_v42.TOKEN_HEADER] = credentials.sessionToken;
    }
    request.headers[REGION_HEADER] = region;
    const payloadHash = await (0, import_signature_v44.getPayloadHash)(request, this.sha256);
    if (!(0, import_signature_v45.hasHeader)(import_signature_v42.SHA256_HEADER, request.headers) && this.applyChecksum) {
      request.headers[import_signature_v42.SHA256_HEADER] = payloadHash;
    }
    const canonicalHeaders = (0, import_signature_v43.getCanonicalHeaders)(request, unsignableHeaders, signableHeaders);
    const canonicalRequest = this.createCanonicalRequest(request, canonicalHeaders, payloadHash);
    const stringToSign = await this.createStringToSign(longDate, scope, canonicalRequest, import_signature_v42.ALGORITHM_IDENTIFIER_V4A);
    const signature = await this.GetSignature(pKey, stringToSign);
    request.headers[import_signature_v42.AUTH_HEADER] = `${import_signature_v42.ALGORITHM_IDENTIFIER_V4A} Credential=${credentials.accessKeyId}/${scope}, SignedHeaders=${this.getCanonicalHeaderList(canonicalHeaders)}, Signature=${signature}`;
    return request;
  }
  /**
   *
